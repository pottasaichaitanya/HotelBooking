...
const Hero = () => {
  ...
  return (
    <div className='flex flex-col items-start justify-center px-6 md:px-16 lg:px-24 xl:px-32 text-white bg-[url("/src/assets/heroImage.png")] bg-cover bg-center bg-no-repeat h-screen'>
     <p className='bg-[#49B9FF]/50 px-3.5 py-1 rounded-full mt-20'> Hotel Experience</p>
     <h1 className='font-playfair text-2xl md:text-5xl md:text-[56px] md:leading-[56px] font-bold md:font-extrabold max-w-xl mt-4'> Discover Your Perfect Destination</h1> 
     <p className='max-w-120 mt-2 text-sm md:text-base'>Unparalleled Luxury and comfort await at the world's most Exclusive hotels and resorts.Start your journey today</p>
     <form onSubmit={onSubmit} className='bg-white text-gray-500 rounded-lg px-6 py-4  flex flex-col md:flex-row max-md:items-start gap-4 max-md:mx-auto'>
